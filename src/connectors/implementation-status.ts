...
export const connectorImplementationStatus: Record<ConnectorProvider, ConnectorImplementationInfo> = {
  ...
  fedex: {
    status: 'live',
    notes: 'Live FedEx rate behavior is handled through the carrier connector; labels remain a registered connector capability stub.',
  },
  usps: {
    status: 'live',
    notes: 'Live USPS rate behavior is handled through the carrier connector; labels remain a registered connector capability stub.',
  },
  shipengine: {
    status: 'live',
  ...
  amazon_shipping: {
    status: 'live',
    notes: 'Live Amazon Shipping rate behavior is handled through the carrier connector; labels remain a registered connector capability stub.',
  },
  ebay: {
    status: 'live',
