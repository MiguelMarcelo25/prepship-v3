...
| PS-439 | Pool-safe worker advisory lock ownership | https://trello.com/c/rFLviYOL | `codex/ps-439-advisory-locks` | Final review | Pool-safe lock ownership and read-only production clearance verified. The duplicate PS-439 inventory-balance card is separate and remains untouched. |
| PS-462 | Canonical inventory ledger quantity and immutable storage billing | https://trello.com/c/9LO26Gtc | `prepshipv4-stable` local candidate | Blocked/Prepared | Collision-free repository identity; the existing inventory Trello card was renamed from duplicate PS-439 to PS-462 on 2026-07-21. Legacy `ps-439-inventory-*` filenames remain compatibility breadcrumbs; release, correction, and rollback evidence use PS-462. |
