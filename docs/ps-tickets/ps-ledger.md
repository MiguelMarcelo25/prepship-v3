...
| PS-462 | Canonical inventory ledger quantity and immutable storage billing | https://trello.com/c/9LO26Gtc | `prepshipv4-stable` local candidate | Blocked/Prepared | Collision-free repository identity for the Trello card still titled duplicate PS-439. Legacy `ps-439-inventory-*` filenames remain compatibility breadcrumbs; release, correction, and rollback evidence use PS-462. No Trello mutation was performed. |
