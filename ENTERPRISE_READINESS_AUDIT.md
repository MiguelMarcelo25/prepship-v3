...
- Observability and alerting are mapped, and API request IDs now flow through response headers, timing/error logs, and detailed Orders list segment timing logs; runtime metric emitters, dashboards, thresholds, alert destinations, and runbook links still need implementation.
