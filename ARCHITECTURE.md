...
- **Where bad/stale/incomplete data can enter** before this fix: ...
...
If the task does not name the canonical owner, return a placement mismatch note before
coding. Do not infer a backend-critical owner from the nearest UI symptom.
