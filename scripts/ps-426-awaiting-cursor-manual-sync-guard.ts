...
assert.match(route, /runManualOrderSyncRoute\([\s\S]*enqueue: ManualOrderSyncEnqueue = enqueueManualOrderSyncJob/);
assert.match(postRoute, /await runManualOrderSyncRoute\(body\)/);
