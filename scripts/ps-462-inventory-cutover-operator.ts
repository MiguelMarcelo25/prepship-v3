...
const APPLY_CONFIRMATION = 'apply-ps-462-inventory-cutover-0074';
...
const migrationPath = 'drizzle/0074_inventory_quantity_cutover.sql';
...
function validateMigration(migration: string): void {
  ...
  if (!migration.includes('0073_inventory_quantity_sot.sql')) {
