...
assert.match(operator, /apply-ps-462-inventory-preparation-0073/);
assert.match(operator, /rollback-ps-462-inventory-preparation-0073/);
...
assert.match(runbook, /49 legacy-to-ledger mismatches/i);
assert.match(runbook, /Do not reopen traffic after phase 1/i);
assert.match(runbook, /correction and `0074` procedures in the same/i);
