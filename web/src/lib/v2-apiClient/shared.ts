...
export type DirectCarrierRateResult = {
  service: string;
  cost: number;
  days?: number;
  currency?: string;
...
export function translateDirectRateToV2Shape(
...
export function directCarrierErrorMessage(provider: string, message: string): string {
...
export async function fetchDirectCarrierRates(
