...
- Locations, carrier accounts, legacy sidebar counts, status polling, worker polling, and markup settings hydration are now guarded on Orders startup, but daily stats and exact-count behavior still need timing evidence before deeper changes.
